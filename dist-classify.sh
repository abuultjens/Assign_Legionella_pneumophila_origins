...
FIRST=`grep ",1" data/target_421_${OB}.csv | cut -f 1 -d ',' | head -1`
grep ",1" data/target_421_${OB}.csv | cut -f 1 -d ',' | tail -n +2 > ${RAND}_rest.txt
...
grep ",1" data/target_421_${OB}.csv | cut -f 1 -d ',' > ${RAND}_fofn.txt
...
cut -f 1 -d ',' data/target_113_${OB}.csv | tail -n +2 > ${RAND}_fofn.txt
...
cut -f 2 -d ',' data/target_113_${OB}.csv | tail -n +2 > ${RAND}_ORIGINAL_class.csv
